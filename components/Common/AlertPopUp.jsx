...
import { Modal, TouchableOpacity, TouchableWithoutFeedback, View, Text, Image } from 'react-native';
      ...
      <TouchableOpacity style={styles.modalBackground} onPress={() => callback()}>
        <TouchableWithoutFeedback>
          <View style={styles.modalContainer}>
            ...
            {renderedBlocks || <Text style={styles.modalMessage}>{messageContent}</Text>}
          </View>
        </TouchableWithoutFeedback>
      </TouchableOpacity>
    </Modal>
