...
import { Modal, TouchableOpacity, TouchableWithoutFeedback, View, Text, Dimensions } from 'react-native';
          ...
          <View style={styles.modalContainer}>
            ...
            {ButtonOne && ButtonTwo ? (
              ...
              <View style={{ flexDirection: 'row' }}>
                <View style={{ flex: 1, marginRight: Dimensions.get('window').width * 0.01 }}>{ButtonOne}</View>
                <View style={{ flex: 1, marginLeft: Dimensions.get('window').width * 0.01 }}>{ButtonTwo}</View>
              </View>
            ) : (
              ButtonOne
            ) // only one button
