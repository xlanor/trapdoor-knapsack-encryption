...
import TrapdoorPermutation from '../../../../../assets/images/IntroImages/1052px-Trapdoor_permutation.svg.png';
      ...
      <View style={style.containerStyle}>
        {showOneWayInfoPopUp ? (
          <AlertPopUp
            ...
            callback={() => {
              this.setState({ showOneWayInfoPopUp: false });
            }}
        ...
        {showDiscreteLogInfoPopUp ? (
          <AlertPopUp
            ...
            callback={() => {
              this.setState({ showDiscreteLogInfoPopUp: false });
            }}
        ...
        <View style={{ height: u * 0.2976 }}>
          <Image source={TrapdoorPermutation} style={style.imgStyle} />
        </View>
        ...
        <Text style={style.contentStyle}>
          ...
          <Text
            style={style.links}
            onPress={() => {
              this.setState({ showOneWayInfoPopUp: true });
            }}
          >
        ...
        <Text style={style.contentStyle}>Assuming we have a function:</Text>

        <View style={{ height: u * 0.058, paddingTop: u * 0.01, paddingBottom: u * 0.01 }}>
          <Image source={DiscreteLogProblem} style={style.imgStyle} />
        </View>

        <Text style={style.contentStyle}>
          Given <Text style={{ ...style.bold, color: '#9B59B6' }}>b</Text>, we would be unable to find{' '}
          <Text style={{ ...style.bold, color: '#1ABC9C' }}>a</Text> and{' '}
          <Text style={{ ...style.bold, color: '#E74C3C' }}>k</Text> in a reasonable time.
          {'\n'}
        </Text>
      </View>
    );
