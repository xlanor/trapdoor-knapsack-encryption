...
// begin redux actions
import { ALGO_UNLOCK_ACTION } from '../../../../../redux-modules/actions/learnPageLock';
import { UNLOCK_TROPHY_HISTORIAN, SHOW_TROPHY_ACTION } from '../../../../../redux-modules/actions/manageTrophies';
      ...
      <>
        ...
        <Animatable.View animation="slideInDown">
          <Card title="Unlocked Next Tab!">
            <RneButton
              type="clear"
              icon={<Image source={Unlock} style={styles.PageStyle.unlockIconStyle} />}
...
UnlockNext.propTypes = {
  actions: PropTypes.shape({
    ...
    UNLOCK_TROPHY_HISTORIAN: PropTypes.func,
