...
import LeonardAdleman from '../../../../../assets/images/IntroImages/leonard-adleman.jpg';
import AdiShamir from '../../../../../assets/images/IntroImages/adi-shamir.jpg';
...
export default class page4 extends Component {
    ...
    return (
      <>
        <View style={{ height: u * m }}>
          <Image source={LeonardAdleman} style={styles.PageStyle.imgStyle} />
        </View>
  ...
  shamirArticleInfoPopUp = () => {
    ...
    return (
      <>
        <View style={{ height: u * m }}>
          <Image source={AdiShamir} style={styles.PageStyle.imgStyle} />
        </View>

        <Text style={{ ...styles.PageStyle.popUpTextStyle, marginTop: u * 0.02 }}>
          Adi Shamir is a co-inventor of the Rivest–Shamir–Adleman (RSA) algorithm (along with Ron Rivest and Len
          Adleman).{' '}
          <Text
            style={styles.PageStyle.links}
      ...
      <View style={style.containerStyle}>
        {showAdlemanArticleInfoPopUp ? (
          <AlertPopUp
            ...
            callback={() => {
              this.setState({ showAdlemanArticleInfoPopUp: false });
            }}
        ...
        {showShamirArticleInfoPopUp ? (
          <AlertPopUp
            ...
            callback={() => {
              this.setState({ showShamirArticleInfoPopUp: false });
            }}
        ...
        {showPriceInfoPopUp ? (
          <AlertPopUp
            ...
            callback={() => {
              this.setState({ showPriceInfoPopUp: false });
            }}
        ...
        {showBrickellInfoPopUp ? (
          <AlertPopUp
            ...
            callback={() => {
              this.setState({ showBrickellInfoPopUp: false });
            }}
        ...
        <Text style={style.contentStyle}>
          ...
          <Text
            style={style.links}
            onPress={() => {
              this.setState({ showAdlemanArticleInfoPopUp: true });
            }}
          >
            Leonard Adleman
          </Text>{' '}
          ...
          <Text
            style={style.links}
            onPress={() => {
              this.setState({ showShamirArticleInfoPopUp: true });
            }}
          >
            Adi Shamir
          </Text>
          ...
          <Text
            style={style.links}
            onPress={() => {
              this.setState({ showPriceInfoPopUp: true });
            }}
          >
            new implementation
          </Text>
          ...
          <Text
            style={style.links}
            onPress={() => {
              this.setState({ showBrickellInfoPopUp: true });
            }}
          >
            broke
          </Text>{' '}
