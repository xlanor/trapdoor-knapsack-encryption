...
import { View, Dimensions, Text, Image, Linking } from 'react-native';

import AlertPopUp from '../../../../Common/AlertPopUp';
import RalphMerkle from '../../../../../assets/images/IntroImages/ralph_merkle.jpeg';
import MartinHellman from '../../../../../assets/images/IntroImages/Martin-Hellman.jpg';
...
export default class page3 extends Component {
    ...
    return (
      <>
        <View style={{ height: u * m }}>
          <Image source={RalphMerkle} style={styles.PageStyle.imgStyle} />
        </View>

        <Text style={{ ...styles.PageStyle.popUpTextStyle, marginTop: u * 0.02 }}>
          Ralph C.Merkle is one of the inventors of public key cryptography and the inventor of cryptographic hashing.{' '}
          <Text
  ...
  martinHellmanInfoPopUp = () => {
    ...
    return (
      <>
        <View style={{ height: u * m }}>
          <Image source={MartinHellman} style={styles.PageStyle.imgStyle} />
        </View>

        <Text style={{ ...styles.PageStyle.popUpTextStyle, marginTop: u * 0.02 }}>
          Martin Edward Hellman is best known for his invention of public key cryptography.{' '}
          <Text
            style={styles.PageStyle.links}
      ...
      <View style={style.containerStyle}>
        {showTrapdoorKnapsackAlgoPopUp ? (
          <AlertPopUp
            ...
            callback={() => {
              this.setState({ showTrapdoorKnapsackAlgoPopUp: false });
            }}
        ...
        {showRalphMerkleInfoPopUp ? (
          <AlertPopUp
            ...
            callback={() => {
              this.setState({ showRalphMerkleInfoPopUp: false });
            }}
        ...
        {showMartinHellmanInfoPopUp ? (
          <AlertPopUp
            ...
            callback={() => {
              this.setState({ showMartinHellmanInfoPopUp: false });
            }}
        ...
        {showProblemsInfoPopUp ? (
          <AlertPopUp
            ...
            callback={() => {
              this.setState({ showProblemsInfoPopUp: false });
            }}
        ...
        <Text style={style.contentStyle}>
          <Text
            style={style.links}
            onPress={() => {
              this.setState({ showRalphMerkleInfoPopUp: true });
            }}
          >
            Ralph Merkle
          </Text>{' '}
          ...
          <Text
            style={style.links}
            onPress={() => {
              this.setState({ showMartinHellmanInfoPopUp: true });
            }}
          >
            Martin Hellman
          </Text>{' '}
          ...
          <Text
            style={style.links}
            onPress={() => {
              this.setState({ showTrapdoorKnapsackAlgoPopUp: true });
            }}
          >
          ...
          <Text
            style={style.links}
            onPress={() => {
              this.setState({ showProblemsInfoPopUp: true });
            }}
          >
            2 separate problems
          </Text>
          . This ensures that the <Text style={styles.PageStyle.privateKey}>private key</Text> is easy to use but the{' '}
          <Text style={styles.PageStyle.publicKey}>public key</Text> is difficult to compute.
          {'\n\n'}
          As such, trapdoor function ensures that without prior knowledge of the "trapdoor", the encryption cannot
          easily be reversed.
          {'\n\n'}
