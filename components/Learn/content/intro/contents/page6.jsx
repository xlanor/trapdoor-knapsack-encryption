        ...
        return (
            <View style={style.containerStyle}>
                ...
                <Text style={style.contentStyle}>
                    A <Text style={style.publicKey}>
                        public key
                    </Text> is generated by multiplying each element of
                    the <Text
                        style={{ ...style.superIncreasingKnapsack, ...style.underline }}
                        onPress={() => {
                            this.setState({ showSuperIncreasingInfoPopUp: true, })
                        }}>superincreasing knapsack
                    </Text> with the <Text style={style.multiplier}>
                        multiplier
                    </Text> and <Text style={style.modulus}>
                        modulus
                    </Text> to get a <Text
                        style={style.links}
                        onPress={() => {
                    ...
                    {"\n\n"}
                    The owner with the <Text style={style.privateKey}>
                        private key
                    </Text> will be able to decrypt and get the original message.
                    {"\n\n"}
