...
export default class page6 extends Component {
        ...
        return (
            <>
                <Text style={styles.PageStyle.popUpTextStyle}>
                    ...
                    <Text style={styles.PageStyle.privateKey}>private keys</Text>.
                </Text>
            </>
        )
    }
        ...
        return (
            <>
                <Text style={styles.PageStyle.popUpTextStyle}>
                    ...
                    {" "}is no longer in a{" "}
                    <Text style={styles.PageStyle.superIncreasingKnapsack}>
    ...
    personInfoPopUp = () => {
        return (
            <>
                <Text style={styles.PageStyle.popUpTextStyle}>
                    This person will then encrypt his message using the{" "}
                    <Text style={styles.PageStyle.publicKey}>public key</Text>
        ...
        return (
            <View style={style.containerStyle}>
                ...
                <Text style={style.contentStyle}>
                    A{" "}
                    <Text style={style.publicKey}>public key</Text>
                    {" "}is generated by multiplying each element of the{" "}
                    <Text
                    ...
                    {" "}with the{" "}
                    <Text style={style.multiplier}>multiplier</Text>
                    {" "}and{" "}
                    <Text style={style.modulus}>modulus</Text>
                    {" "}to get a{" "}
                    <Text
                        style={style.links}
                        onPress={() => {
                    ...
                    {"\n\n"}
                    The owner with the{" "}
                    <Text style={style.privateKey}>private key</Text>
                    {" "}will be able to decrypt and get the original message.
                    {"\n\n"}
