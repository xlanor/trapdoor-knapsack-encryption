        ...
        return (
            <View style={style.containerStyle}>
                ...
                <Text style={style.contentStyle}>
                    A <Text style={style.publicKey}>public key</Text> is generated by multiplying each
                    element of the <Text style={style.superIncreasingKnapsack} onPress={()=>{this.setState({showSuperIncreasingInfoPopUp:true,})}}>
                        <Text style={style.underline}>superincreasing knapsack</Text>
                    </Text> with the <Text style={style.multiplier}>multiplier</Text> and <Text style={style.modulus}>modulus</Text> to
                    get a <Text style={style.links} onPress={() => { this.setState({ showDifficultKnapsackInfoPopUp: true, }) }}>
                        difficult knapsack
                    </Text>.
                    {"\n\n"}

                    This <Text style={style.publicKey}>public key</Text> is then given
                    to a <Text style={style.links} onPress={() => { this.setState({ showPersonInfoPopUp: true, }) }}>
                        person
