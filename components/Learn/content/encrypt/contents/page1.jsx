    ...
    return (
      <>
        {keyboardVisiblity ? null : (
          <>
            <Text style={styles.tutorial.contentStyle}>
              Now, to encrypt a message, you first need to convert the message into ascii values and then to binary.
            </Text>
          </>
        )}
        <View
        ...
        >
          ...
          <TextInput
            defaultValue={textToEncrypt === '' ? null : textToEncrypt}
            style={styles.tutorial.textBoxStyle}
            onChangeText={text => {
        ...
        {keyboardVisiblity ? null : (
          <>
            ...
            >
              ...
              <Text style={styles.tutorial.knapsackSizeStyle}>knapsack size n</Text> to corresponding{' '}
              <Text style={styles.tutorial.publicKey}>public key</Text> (binary length ÷ n)
            </Text>
            <Text
              style={{
                ...styles.tutorial.contentStyle,
            ...
            >
              Add the <Text style={styles.tutorial.publicKey}>public key b</Text> that corresponds to the value 1 in
              binary x
            </Text>
          </>
        )}
