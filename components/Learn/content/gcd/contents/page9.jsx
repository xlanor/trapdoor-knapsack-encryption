  ...
  render() {
    ...
    return (
      <View style={style.containerStyle}>
        ...
        >
          Let <Text style={style.valA}>a</Text> be the previous b.{'\n'}
          Let <Text style={style.valB}>b</Text> be the previous r.
        </Text>
        <Text style={{ ...style.contentStyle, marginTop: u * 0.02 }}>
          Calculate <Text style={style.bold}>a1</Text> and <Text style={style.bold}>b1</Text> using the formulas below:
        </Text>
        <Text
          style={{
            ...style.contentStyle,
        ...
        <Text style={{ ...style.contentStyle, marginTop: u * 0.02 }}>
          Let <Text style={style.bold}>a1</Text> be the <Text style={style.bold}>previous a2</Text> and{' '}
          <Text style={style.bold}>b1</Text> be the <Text style={style.bold}>previous b2</Text>.{'\n'}
        </Text>
      </View>
    );
  }
