...
import { View, Dimensions, Button, Text, Image, TouchableOpacity, KeyboardAvoidingView, FlatList } from 'react-native';
// import stylesheet.
    ...
    return (
      <View style={style.containerStyle}>
        ...
        <Text style={style.contentStyle}>
          To find out the <Text style={{ ...style.inverseStyle, ...style.bold }}>modular inverse</Text>:
        </Text>
        <Text style={{ ...style.contentStyle, marginLeft: u * 0.03 }}>
          ...
          {'\n'}
          2. <Text style={{ ...style.inverseStyle, ...style.bold }}>Inverse</Text> of{' '}
          <Text style={{ ...style.bold, ...style.valB }}>b</Text> is <Text style={style.bold}>last value</Text> of{' '}
          <Text style={style.bold}>b2</Text>
        </Text>
        <Text style={{ ...style.contentStyle, marginTop: u * 0.02 }}>
          If the <Text style={{ ...style.bold, ...style.GCDStyle }}>gcd</Text> is not 1, there is no{' '}
          ...
          for <Text style={{ ...style.bold, ...style.valA }}>a</Text> is the <Text style={style.bold}>last value</Text>{' '}
          of <Text style={style.bold}>a2</Text>.{'\n'}
        </Text>
      </View>
    );
  }
