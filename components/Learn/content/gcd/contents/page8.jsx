      ...
      <View style={style.containerStyle}>
        ...
        <Text style={style.contentStyle}>
          ...
          <Text style={style.bold}>
            same 2 integers <Text style={style.valA}>a</Text> and <Text style={style.valB}>b</Text>
          </Text>
          , <Text style={style.highlight}>282</Text> and <Text style={style.highlight}>23</Text>.{'\n\n'}
        ...
        >
          - Let <Text style={style.bold}>a1 = 1, a2 = 0, b1 = 0, b2 = 1</Text>
