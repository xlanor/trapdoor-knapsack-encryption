    ...
    return (
      <>
        <Text style={styles.GCDPages.popUpTextStyle}>
          An algorithm named after the <Text style={styles.GCDPages.bold}>ancient Greek mathematician Euclid</Text>. It
          can be used to reduce fractions to their simplest form, and is a part of many number-theoretic and
    ...
    return (
      <View style={style.containerStyle}>
        ...
        <Text style={style.contentStyle}>
          ...
          <Text style={{ ...style.bold, ...style.GCDStyle }}>Greatest Common Divisor(GCD)</Text> of{' '}
        ...
        <Text style={style.contentStyle}>
          where <Text style={{ ...style.bold, ...style.valA }}>a</Text> and{' '}
          <Text style={{ ...style.bold, ...style.valB }}>b</Text> are{' '}
          <Text style={style.bold}>2 different integers</Text> and <Text style={style.bold}>x</Text> is the result.
          {'\n\n'}
          This refers to what the <Text style={{ ...style.bold, ...style.GCDStyle }}>GCD</Text> of{' '}
          <Text style={{ ...style.bold, ...style.valA }}>a</Text> and{' '}
