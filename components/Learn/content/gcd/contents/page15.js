export default pageFifteen = {
    ...
    If your find that the GCD is not 1, there is no multiplicative inverse for the value you are comparing<br/>
    So to get the multiplicative inverse of 23 when modulus is 282<br/>
    Since 23 is under b, we look at b2<br/>
    If you did the table differently and the value is under a then look at a2<br/>
    b2 is -49 and therefore, the multiplicative inverse of 23 is -49 mod 292<br/>
    Since -49 is negative,<br/>
    282 - 49 = 233<br/>
    <b>233 is the multiplicative inverse of 23.</b></p>`
}