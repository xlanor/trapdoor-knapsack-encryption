    ...
    return (
      <View style={style.containerStyle}>
        ...
        <Text style={style.contentStyle}>
          For example, to find the <Text style={{ ...style.bold, ...style.GCDStyle }}>GCD</Text> of{' '}
          <Text style={style.highlight}>23</Text> and <Text style={style.highlight}>282</Text>, insert the 2 integers
          into the table.
          {'\n\n'}
          ...
          {'\n\n'}
          Let <Text style={{ ...style.bold, ...style.valA }}>a</Text> be <Text style={style.highlight}>282</Text> and{' '}
          <Text style={{ ...style.bold, ...style.valB }}>b</Text> be <Text style={style.highlight}>23</Text>.{'\n'}
        </Text>
      </View>
    );
  }
