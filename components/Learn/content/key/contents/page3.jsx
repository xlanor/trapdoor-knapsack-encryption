      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={keyboardVisiblity ? { ...styles.page1.keyboardAvoidingViewMargin } : null}>
          ...
          <Text style={{ ...styles.page1.contentStyle, marginTop: Dimensions.get('window').height * 0.02 }}>
            (This <Text style={{ ...styles.page1.multiplierStyle, ...styles.page1.boldFont }}>multiplier w</Text> must
            be a{' '}
            <Text style={styles.page1.linkStyle} onPress={showCoprimeInfoPopUp}>
              co-prime
            </Text>{' '}
            to your <Text style={styles.page1.modulusStyle}>modulus m</Text>)
          </Text>
          <View style={{ marginTop: Dimensions.get('window').height * 0.02 }}>
            <Text style={styles.page1.contentStyle}>
              This means{' '}
              <Text style={{ ...styles.page1.GCDStyle, ...styles.page1.boldFont }}>
          ...
          <View style={{ marginTop: Dimensions.get('window').height * 0.03 }}>
            <TextInput
              defaultValue={curMultiplier === 0 ? null : curMultiplier.toString()}
