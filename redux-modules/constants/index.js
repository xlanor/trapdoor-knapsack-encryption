...
export const TROPHY_HISTORIAN = 'TROPHY_HISTORIAN';
export const TROPHY_EZ_MATH = 'TROPHY_EZ_MATH';
export const TROPHY_KEYRING = 'TROPHY_KEYRING';
export const TROPHY_CONCEALMENT = 'TROPHY_CONCEALMENT';
export const TROPHY_REVEAL = 'TROPHY_REVEAL';
export const TROPHY_KEYMASTER = 'TROPHY_KEYMASTER';
export const TROPHY_SAFETY_FIRST = 'TROPHY_SAFETY_FIRST';
export const TROPHY_BREAK_WALL = 'TROPHY_BREAK_WALL';
export const TROPHY_RESET = 'TROPHY_RESET';
export const SHOW_TROPHY = 'SHOW_TROPHY';
export const HIDE_TROPHY = 'HIDE_TROPHY';
